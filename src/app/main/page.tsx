      ...
      <div className="flex flex-col">
        ...
        >
          <Link href="/main/board" className="w-[48%] block">
            <Card
              className='h-full cursor-pointer flex flex-col items-center justify-evenly relative overflow-hidden bg-[url("/pubao.gif")] bg-cover bg-center bg-no-repeat
          ...
          <Link href="/main/mypage/myRoute" className="w-[48%] block">
            <Card
              className='h-full cursor-pointer flex flex-col items-center justify-evenly relative overflow-hidden bg-[url("/bird.gif")] bg-cover bg-center bg-no-repeat
                dark:before:content-[""] dark:before:absolute dark:before:inset-0 dark:before:bg-black/20'
            >
              <div className="absolute inset-0 bg-black/30" />
              <div className="relative z-10 h-full p-4 flex items-center justify-center">
        ...
        <Link href="/main/board/post" className="w-[100%] block mt-4">
          <Card
            className='h-28 cursor-pointer flex flex-col items-center justify-evenly relative overflow-hidden bg-[url("/share.webp")] bg-cover bg-center bg-no-repeat
                dark:before:content-[""] dark:before:absolute dark:before:inset-0 dark:before:bg-black/20'
          >
            <div className="absolute inset-0 bg-black/30" />
            <div className="relative z-10 h-full p-4 flex items-center justify-center">
