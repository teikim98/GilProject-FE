              ...
              >
                <div className=" w-full items-center gap-4 flex flex-col">
                  ...
                  <div className="flex flex-row justify-center items-center gap-4 w-full">
                    ...
                    <Link href={`${process.env.NEXT_PUBLIC_API_URL}/login/oauth2/code/google`} passHref>
                    ...
                    <div className="flex-1 flex justify-center">
                      ...
                      <Link href={`${process.env.NEXT_PUBLIC_API_URL}/login/oauth2/code/naver`} passHref>
                        <Avatar className="cursor-pointer">
                    ...
                    <div className="flex-1 flex justify-center">
                      <Link href={`${process.env.NEXT_PUBLIC_API_URL}/login/oauth2/code/kakao`} passHref>
                        <Avatar className="cursor-pointer">
